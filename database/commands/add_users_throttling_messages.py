...
async def add_users_throttling_messages(user_id: int, throttling_key: str, sleep_time: int) -> None:
    ...
    try:
        ...
        # throttling message with the specified key and should wait for the specified time before sending another
        # message. The create() method is a method of the UsersMessages model,
