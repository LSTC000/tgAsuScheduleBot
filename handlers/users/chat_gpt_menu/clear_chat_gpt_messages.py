...
from data.messages import CLEAR_CHAT_GPT_MESSAGES_MESSAGE
from data.messages import CONFIRM_CLEAR_CHAT_GPT_MESSAGES_MESSAGE
from data.messages import CANCEL_CLEAR_CHAT_GPT_MESSAGES_MESSAGE
from data.messages import EMPTY_CHAT_GPT_MESSAGES_MESSAGE

from keyboards import chat_gpt_clear_history_message_ikb
...
@dp.message_handler(
    lambda m: m.text == CLEAR_CHAT_GPT_MESSAGES_RKB_BUTTON_MESSAGE,
...
async def clear_chat_gpt_messages(message: types.Message, state: FSMContext) -> None:
    async with state.proxy() as data:
        ...
        if data['count_chat_gpt_messages']:
            ikb = chat_gpt_clear_history_message_ikb()
            msg = CLEAR_CHAT_GPT_MESSAGES_MESSAGE
