...
@dp.message_handler(
    ...
    state=ChatGptMenuStatesGroup.chat_gpt_confirm_cancel_to_main_menu
)
...
async def invalid_chat_gpt_cancel_to_main_menu_message(message: types.Message) -> None:
    await bot.send_message(
        ...
        text=INVALID_CHAT_GPT_CANCEL_TO_MAIN_MENU_MESSAGE.format(message.from_user.first_name)
    )
