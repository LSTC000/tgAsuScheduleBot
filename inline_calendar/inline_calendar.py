...
class InlineCalendar:
        ...
        for week in month_calendar:
            ...
            for day in week:
                ...
                inline_kb.insert(InlineKeyboardButton(
                    ...
                    # DAY is CALLBACK_DATA_GET_CALENDAR_SCHEDULE_SEPARATOR.
    ...
    async def process_selection(self, callback: types.CallbackQuery, callback_data: str, state: FSMContext) -> tuple:
        ...
        try:
            ...
            # CALLBACK_DATA_GET_CALENDAR_SCHEDULE_SEPARATOR is separator from data/config/callbacks/callbacks_data.
            ...
            # PREV-YEAR is callback data in CALLBACK_DATA_GET_CALENDAR_SCHEDULE from
            # data/config/callbacks/callbacks_data.
            ...
            # NEXT-YEAR is callback data in CALLBACK_DATA_GET_CALENDAR_SCHEDULE from
            # data/config/callbacks/callbacks_data.
            ...
            # PREV-MONTH is callback data in CALLBACK_DATA_GET_CALENDAR_SCHEDULE from
            # data/config/callbacks/callbacks_data.
            ...
            # NEXT-MONTH is callback data in CALLBACK_DATA_GET_CALENDAR_SCHEDULE from
            # data/config/callbacks/callbacks_data.
