...
faculties_records = faculties['records']
...
for faculties_record in faculties_records:
    ...
    for chairs_record in chairs_records:
        ...
        lecturers_records = lecturers['records']
...
with open('lecturers.json', 'w', encoding='utf-8') as file:
    json.dump({'lecturers': lecturer_list}, file, indent=4, ensure_ascii=False)
