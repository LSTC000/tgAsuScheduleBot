...
from data.config import THROTTLING_SLEEP_TIME
from data.config import CHAT_GPT_MESSAGE_KEY
from data.config import VOICE_TYPE
from data.config import TEXT_TYPE

from data.messages import THROTTLING_MESSAGE

from database import add_users_throttling_messages
from database import add_users_messages
from database import add_users_chat_gpt_messages
