...
from data.messages import (
    GET_ALLEGED_TARGETS_URLS_DICT_RESPONSE_OR_JSON_ERROR_STUDENT_MESSAGE,
    GET_ALLEGED_TARGETS_URLS_DICT_RESPONSE_OR_JSON_ERROR_LECTURER_MESSAGE,
    GET_ALLEGED_TARGETS_URLS_DICT_NONE_TARGET_NAME_ERROR_STUDENT_MESSAGE,
    GET_ALLEGED_TARGETS_URLS_DICT_NONE_TARGET_NAME_ERROR_LECTURER_MESSAGE,
    GET_ALLEGED_TARGETS_URLS_DICT_COUNT_SHOW_ALLEGED_TARGET_NAMES_THRESHOLD_ERROR_STUDENT_MESSAGE,
    GET_ALLEGED_TARGETS_URLS_DICT_COUNT_SHOW_ALLEGED_TARGET_NAMES_THRESHOLD_ERROR_LECTURER_MESSAGE,
    GET_DAILY_SCHEDULE_DICT_RESPONSE_OR_JSON_ERROR_STUDENT_MESSAGE,
    GET_DAILY_SCHEDULE_DICT_RESPONSE_OR_JSON_ERROR_LECTURER_MESSAGE,
    GET_WEEKLY_SCHEDULE_LIST_RESPONSE_OR_JSON_ERROR_STUDENT_MESSAGE,
    GET_WEEKLY_SCHEDULE_LIST_RESPONSE_OR_JSON_ERROR_LECTURER_MESSAGE
)
