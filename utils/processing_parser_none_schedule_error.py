...
from data.messages import (
    GET_DAILY_SCHEDULE_DICT_TODAY_NONE_SCHEDULE_ERROR_STUDENT_MESSAGE,
    GET_DAILY_SCHEDULE_DICT_TOMORROW_NONE_SCHEDULE_ERROR_STUDENT_MESSAGE,
    GET_DAILY_SCHEDULE_DICT_CALENDAR_NONE_SCHEDULE_ERROR_STUDENT_MESSAGE,
    GET_WEEKLY_SCHEDULE_LIST_NONE_SCHEDULE_ERROR_STUDENT_MESSAGE,
    GET_DAILY_SCHEDULE_DICT_TODAY_NONE_SCHEDULE_ERROR_LECTURER_MESSAGE,
    GET_DAILY_SCHEDULE_DICT_TOMORROW_NONE_SCHEDULE_ERROR_LECTURER_MESSAGE,
    GET_DAILY_SCHEDULE_DICT_CALENDAR_NONE_SCHEDULE_ERROR_LECTURER_MESSAGE,
    GET_WEEKLY_SCHEDULE_LIST_NONE_SCHEDULE_ERROR_LECTURER_MESSAGE
)
